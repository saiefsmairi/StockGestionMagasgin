...
public interface ReclamationRepository extends JpaRepository<Reclamation,Long> {
	...
	@Query("select u from Reclamation u where u.isresponded=1 and u.client.idClient = :clientid") 
	List<Reclamation> ReclamationRespondedPerClient(@Param(value = "clientid") long clientid);
